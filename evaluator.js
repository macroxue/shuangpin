var schemes = {
  ...
  UAI优化顶功:'Q=iu,W=en,E=-,R=ou,T=ue ve ui,Y=uan,U=sh,I=|,O=uo \\,P=un,A=^,S=ao,D=ang,F=eng er,G=ing,H=ong iong,J=ai 0,K=an,L=ian uai,FH=iang uang /,X=ia ua,C=ie ch,V=zh,B=in,N=iao,M=ei',
